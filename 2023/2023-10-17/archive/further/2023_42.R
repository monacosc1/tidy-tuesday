...
### |-  fonts ----
font_add('fa6-brands', './2023/2023-10-17/archive/further/Font Awesome 6 Brands-Regular-400.otf') 
...
taylor_tbl_long %>%
  ggplot(aes(x = variable, y = value, group = track_number, color = album_name)) +
